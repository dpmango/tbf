...
const AudioPoster = ({ className, video, children, onProgress }) => {
  ...
  const checkVolume = (dir) => {
    if (dir) {
      let currentVolume = Math.floor(videoRef.current.volume * 10) / 10;
      if (dir === '+') {
      ...
      videoRef.current.muted = currentVolume <= 0;
    }
  ...
  const handleProgressClick = (e) => {
    ...
    let pos = (e.pageX - progressPosLeft) / progressRef.current.offsetWidth;
      ...
      <div className={styles.videoControls}>
        <div className={styles.videoControlsWrapper}>
          ...
          <div className={styles.videoProgress}>
            <progress value="0" ref={progressRef} onClick={handleProgressClick}>
